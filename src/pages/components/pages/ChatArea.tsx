...
import "./ChatArea.css";
import { getHistory, ClassifyPlant } from "../../../service/PlantsService"; // Import qilingan API funksiyalari
...
function ChatArea() {
  ...
  const handleSendImage = async () => {
    if (selectedImage && imagePreview) {
      ...
      // ClassifyPlant funksiyasi FormData obyektini qabul qilishi kerak
      try {
        ...
        setSelectedImage(null);
        setImagePreview(null);
        // Fayl inputining qiymatini tozalash (agar kerak bo'lsa)
